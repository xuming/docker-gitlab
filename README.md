...
<<<<<<< HEAD
    sameersbn/gitlab:10.8.3 app:sanitize
=======
    sameersbn/gitlab:11.3.0 app:sanitize
>>>>>>> sameersbin/master
```
...
docker run --name gitlab -it --rm [OPTIONS] \
<<<<<<< HEAD
    sameersbn/gitlab:10.8.3 app:rake db:setup
=======
    sameersbn/gitlab:11.3.0 app:rake db:setup
>>>>>>> sameersbin/master
```
...
docker run --name gitlab -it --rm [OPTIONS] \
<<<<<<< HEAD
    sameersbn/gitlab:10.8.3 app:rake gitlab:env:info
=======
    sameersbn/gitlab:11.3.0 app:rake gitlab:env:info
>>>>>>> sameersbin/master
```
...
docker run --name gitlab -it --rm [OPTIONS] \
<<<<<<< HEAD
    sameersbn/gitlab:10.8.3 app:rake gitlab:import:repos
=======
    sameersbn/gitlab:11.3.0 app:rake gitlab:import:repos
>>>>>>> sameersbin/master
```
...
>
<<<<<<< HEAD
> Upgrading to `sameersbn/gitlab:10.8.3` from `sameersbn/gitlab:7.x.x` can cause issues. It is therefore required that you first upgrade to `sameersbn/gitlab:8.0.5-1` before upgrading to `sameersbn/gitlab:8.1.0` or higher.
=======
> Upgrading to `sameersbn/gitlab:11.3.0` from `sameersbn/gitlab:7.x.x` can cause issues. It is therefore required that you first upgrade to `sameersbn/gitlab:8.0.5-1` before upgrading to `sameersbn/gitlab:8.1.0` or higher.
>>>>>>> sameersbin/master
...
```bash
<<<<<<< HEAD
docker run --name gitlab -d [OPTIONS] sameersbn/gitlab:10.8.3
=======
docker run --name gitlab -d [OPTIONS] sameersbn/gitlab:11.3.0
>>>>>>> sameersbin/master
```
